...
var _excluded12 = ["children", "className", "color", "component", "disabled", "disableFocusRipple", "focusVisibleClassName", "size", "variant"];
...
init_objectWithoutPropertiesLoose();
init_esm();
var _excluded14 = ["boundaryCount", "componentName", "count", "defaultPage", "disabled", "hideNextButton", "hidePrevButton", "onChange", "page", "showFirstButton", "showLastButton", "siblingCount"];
...
var _excluded15 = ["className", "color", "component", "components", "disabled", "page", "selected", "shape", "size", "slots", "type", "variant"];
...
var _excluded16 = ["boundaryCount", "className", "color", "count", "defaultPage", "disabled", "getItemAriaLabel", "hideNextButton", "hidePrevButton", "onChange", "page", "renderItem", "shape", "showFirstButton", "showLastButton", "siblingCount", "size", "variant"];
...
var SpeedDial = React33.forwardRef(function SpeedDial2(inProps, ref) {
  ...
  const {
    ...
    TransitionProps
  } = props, FabProps = _objectWithoutPropertiesLoose(props.FabProps, _excluded20), other = _objectWithoutPropertiesLoose(props, _excluded24);
  ...
  const eventTimer = React33.useRef();
  React33.useEffect(() => {
    return () => {
  ...
  return (0, import_jsx_runtime40.jsxs)(SpeedDialRoot, _extends({
    className: clsx_default(classes.root, className),
    ref,
    role: "presentation",
    onKeyDown: handleKeyDown,
    ...
    children: [(0, import_jsx_runtime39.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime39.jsx)(SpeedDialFab, _extends({
        color: "primary",
    ...
    })), (0, import_jsx_runtime39.jsx)(SpeedDialActions, {
      id: `${id}-actions`,
      role: "menu",
...
//# sourceMappingURL=chunk-3TBKG3MR.js.map
